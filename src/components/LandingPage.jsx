...
const UNAsciiLogo = () => {
  ...
  return (
    <div className="ascii-art-container rounded-lg p-2 cursor-pointer select-none overflow-hidden">
      <pre className="ascii-art-glow text-[#009EDB] text-[0.12rem] sm:text-[0.14rem] md:text-[0.18rem] lg:text-[0.22rem] leading-[1.1] font-mono whitespace-pre" style={{ aspectRatio: '1/1' }}>
        {asciiArt}
      </pre>
    </div>
  );
