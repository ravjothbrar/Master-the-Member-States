...
const UNAsciiLogo = () => {
  // Transcribed from reference UN emblem ASCII art
  const asciiArt = `                                       ****************************************
                                *************************************************************
                           *****************                       *******************
                       **************       ****           ****       **************
  ...
  return (
    <div className="ascii-art-container rounded-lg p-2 cursor-pointer select-none overflow-hidden">
      <pre className="ascii-art-glow text-[#009EDB] text-[0.11rem] sm:text-[0.13rem] md:text-[0.17rem] lg:text-[0.21rem] leading-[1.15] font-mono whitespace-pre">
        {asciiArt}
      </pre>
    </div>
  );
